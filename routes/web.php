...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/profile', [App\Http\Controllers\ProfileController::class, 'showProfile'])
        ->name('profile');
    Route::post('/users/{id}', [App\Http\Controllers\Auth\UserController::class, 'userUpdate'])
        ->name('userUpdate');

    Route::get('/requests', [App\Http\Controllers\OrderRequestController::class, 'index'])
        ->name('requests');
    Route::get('/request/register', [App\Http\Controllers\OrderRequestController::class, 'showRegistrationForm'])
    ...
    Route::get('/supplier/register', [App\Http\Controllers\SupplierController::class, 'showRegistrationForm'])
