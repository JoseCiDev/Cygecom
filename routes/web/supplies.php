...
Route::middleware(['auth', 'profile:suprimentos_hkm,suprimentos_inp'])->group(function () {
    ...
    Route::group(['prefix' => 'supplies'], function () {
        ...
        Route::get('service/{id}/details', [App\Http\Controllers\ServiceController::class, 'serviceDetails'])->name('supplies.service.detail');
        Route::get('product/{id}/details', [App\Http\Controllers\ProductController::class, 'productDetails'])->name('supplies.product.detail');
        Route::get('contract/{id}/details', [App\Http\Controllers\ContractController::class, 'contractDetails'])->name('supplies.contract.detail');
