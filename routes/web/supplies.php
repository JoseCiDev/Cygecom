...
Route::middleware(['auth', 'profile:suprimentos_hkm,suprimentos_inp'])->group(function () {
    ...
    Route::get('/supplies/service/{suppliesGroup}/{status?}', [App\Http\Controllers\SuppliesController::class, 'service'])->name('supplies.service.filter');
    Route::get('/supplies/product/{suppliesGroup}/{status?}', [App\Http\Controllers\SuppliesController::class, 'product'])->name('supplies.product.filter');
    Route::get('/supplies/contract/{suppliesGroup}/{status?}', [App\Http\Controllers\SuppliesController::class, 'contract'])->name('supplies.contract.filter');
