...
Route::middleware('auth')->group(function () {
    Route::group(['prefix' => 'supplies'], function () {
        ...
        Route::group(['prefix' => 'product'], function () {
            ...
            Route::middleware('can:post.supplies.product.update')->post('/update/{purchaseRequest}', [App\Http\Controllers\SuppliesController::class, 'updateProduct'])->name('supplies.product.update');
        });
        ...
        Route::group(['prefix' => 'contract'], function () {
            ...
            Route::middleware('can:post.supplies.contract.update')->post('/update/{purchaseRequest}', [App\Http\Controllers\SuppliesController::class, 'updateContract'])->name('supplies.contract.update');
        });
    });
});
