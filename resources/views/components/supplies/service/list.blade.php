    ...
    <div class="col-sm-12">
        <div class="box box-color box-bordered">
            ...
            <div class="box-content nopadding regular-text">
                ...
                <table id="table-supplies-list" class="table table-hover table-nomargin table-striped" data-column_filter_dateformat="dd-mm-yy" style="width:100%" data-nosort="0"
                    data-checkall="all">
                    <thead>
                        <tr class="search-bar">
                            <th></th>
                        ...
                        @foreach ($services as $index => $service)
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="white-space: nowrap;">
                                    <button class="btn btn-mini btn-secondary" data-id="{{ $service->id }}" data-bs-toggle="modal" data-bs-target="#modal-supplies-service-info"
                                    ...
                                    @endphp
                                    <a href="{{ route('supplies.service.detail', ['id' => $service->id]) }}" class="btn btn-mini btn-secondary openDetail" title="Abrir"
