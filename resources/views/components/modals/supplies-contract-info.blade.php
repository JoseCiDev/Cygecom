@push('styles')
    <style>
        #modal-supplies-contract-info .modal-body {
            padding-bottom: 50px;
        }
...
<div class="modal fade" id="modal-supplies-contract-info" tabindex="-1" role="dialog" aria-labelledby="modal-label" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-label">
                    <strong>Solicitação de serviço recorrente - Nº <span class="modal-request-id"></span></strong>
                </h4>
...
@push('scripts')
    <script type="module">
        $(() => {
            ...
            const $suppliesProductInfo = $('#modal-supplies-contract-info');
            ...
            $suppliesProductInfo.on('show.bs.modal', function(event) {
                ...
                $.get({
                    ...
                    success: (data) => {
                        ...
                        const supplier = {
                            corporate_name: contract.supplier?.corporate_name,
                            cpf_cnpj: contract.supplier?.cpf_cnpj,
                            market_type: contract.supplier?.market_type
                        };
