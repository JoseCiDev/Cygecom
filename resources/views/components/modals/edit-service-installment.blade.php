<div class="modal fade" id="modal-edit-service-installment" tabindex="-1" aria-labelledby="modal-edit-service-installment-label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modal-edit-service-installment-label">Editar Parcela<strong class="name"></strong></h1>
            ...
            <form id="form-modal-edit-service-installment" data-cy="form-modal-edit-service-installment" class="form-validate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="edit-status" data-cy="edit-status" class='select2-me' data-dropdown-parent="#modal-edit-service-installment"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-small" data-bs-dismiss="modal" data-cy="btn-edit-observation-cancel">
                        Cancelar
                    </button>
