<div class="modal fade" id="modal-edit-product-installment" tabindex="-1" role="dialog" aria-labelledby="modal-label"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="form-modal-edit-product-installment" class="form-validate">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-small" data-dismiss="modal">
                        Cancelar
                    </button>
