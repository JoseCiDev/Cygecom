        ...
        <div class="col-sm-12">
            ...
            <div class="box box-color box-bordered colored">
                ...
                <div class="box-content">
                    <form action="{{route('profile', ['updateAction' => 'address'])}}" method="POST" class='form-vertical'>
                        @csrf
                        <div class="row">
                            <div class="col-sm-3">
            ...
            <div class="box box-color box-bordered colored">
                ...
                <div class="box-content">
                    <form action="{{route('profile', ['updateAction' => 'identification'])}}" method="post" class='form-vertical'>
                        @csrf
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
            ...
            <div class="box box-color box-bordered colored">
                ...
                <div class="box-content">
                    <form action="{{route('profile', ['updateAction' => 'phone'])}}" method="post" class='form-vertical'>
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="box box-color box-bordered colored">
                ...
                <div class="box-content">
                    <form action="{{route('profile', ['updateAction' => 'user'])}}" method="POST" class='form-vertical'>
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                @if (auth()->user()->profile->profile_name === 'admin')
