...
$(document).ready(function () {
    ...
    $(document).on('click', '.content-slideUp', function (e) {
        e.preventDefault();
        var $el = $(this),
    ...
    $(".content-remove").click(function (e) {
        ...
        bootbox.confirm("Gostaria de remover este CNPJ e o(s) produtos vinculados? <strong>", function (r) {
            if (r) {
    ...
    // setando cor padrão => class darkblue
    body = $('body');
    body.attr("class", "").addClass("theme-" + "darkblue");
