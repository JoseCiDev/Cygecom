...
class Abilities extends Seeder
{
    public function run(): void
    {
        $routesAbilities = [
            ...
            ['id' => 5, 'name' => 'post.suppliers.store', 'description' => 'Registrar novo fornecedor'],

            // Supplies
            ['id' => 6, 'name' => 'get.supplies.index', 'description' => 'Acessar tela de dashboard de suprimentos'],
            ['id' => 7, 'name' => 'get.supplies.service.index', 'description' => 'Acessar tela de solicitações de serviços pontuais'],
            ['id' => 8, 'name' => 'get.supplies.product.index', 'description' => 'Acessar tela de solicitações de produtos'],
            ['id' => 9, 'name' => 'get.supplies.contract.index', 'description' => 'Acessar tela de solicitações de serviços recorrentes'],
            ['id' => 10, 'name' => 'get.supplies.service.show', 'description' => 'Acessar tela de detalhes de uma solicitações de serviço pontual'],
            ['id' => 11, 'name' => 'get.supplies.product.show', 'description' => 'Acessar tela de detalhes de uma solicitações de produto'],
            ...
            // Requests
            ['id' => 17, 'name' => 'get.requests.index.own', 'description' => 'Acessar tela de minhas solicitações'],
            ['id' => 18, 'name' => 'get.requests.dashboard', 'description' => 'Acessar tela de dashboard de nova solicitação'],
            ['id' => 19, 'name' => 'get.requests.service.create', 'description' => 'Acessar tela de registrar nova solicitação de serviço pontual'],
            ['id' => 20, 'name' => 'post.requests.service.store', 'description' => 'Registrar nova solicitação de serviço pontual'],
            ['id' => 21, 'name' => 'post.requests.service.update', 'description' => 'Atualizar nova solicitação de serviço pontual'],
            ['id' => 22, 'name' => 'get.requests.product.create', 'description' => 'Acessar tela de registrar nova solicitação de produto'],
            ['id' => 23, 'name' => 'post.requests.product.store', 'description' => 'Registrar nova solicitação de produto'],
            ['id' => 24, 'name' => 'post.requests.product.update', 'description' => 'Atualizar nova solicitação de produto'],
            ['id' => 25, 'name' => 'get.requests.contract.create', 'description' => 'Acessar tela de registrar nova solicitação de serviço recorrente'],
            ['id' => 26, 'name' => 'post.requests.contract.store', 'description' => 'Registrar nova solicitação de serviço recorrente'],
